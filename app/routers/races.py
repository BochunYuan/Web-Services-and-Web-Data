...
async def list_races(
    ...
    year: Optional[int] = Query(default=None, ge=1950, le=2100, description="Filter by season year"),
...
@router.post(
    ...
    description="""
Requires authentication. Creates a new race entry for extensibility demos and does not
replace an existing season round unless you explicitly update that race by ID.
    """,
)
