...
@router.post(
    ...
    description="""
Requires authentication. Creates a brand-new driver row and does not overwrite existing
historical records unless you explicitly call `PUT /api/v1/drivers/{driver_id}`.
Returns 409 if `driver_ref` already exists.
    """,
)
